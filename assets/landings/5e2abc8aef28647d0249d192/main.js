...
(function($) {
   ...
   ================================================ */
    ...
    var owlProps = {
        ...
        margin: 0,
        nav: true,
        navText: ["<img src='https://wondabra.com/images/right-angle-white.png'>", "<img src='https://wondabra.com/images/right-angle-white.png'>"]
    }

    $('#slider').owlCarousel(owlProps);
    ...
    if(isMobile) {
        $('#reviews .review').show();
        $('#reviews .flex').owlCarousel(owlProps);
    }


    // Add image height equal to container
    const imageContainerHeight = $('.left-right-pictures').height();
    $('.left-right-pictures .picture img').css('height', imageContainerHeight);
